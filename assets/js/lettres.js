$(document).ready(function(){
    ...
    let first_salve_button = $("#vocabulaire button:first-of-type");
    let second_salve_button = $("#vocabulaire button:nth-of-type(2)");

    first_salve_button.click(function () {
        $.ajax({
            url: "ajax/vocabulaire.php?entrainement=true",
            method: "GET"
        })
            .done(function (response) {
                $("#test-area").html(response);
    ...
    second_salve_button.click(function () {
        $.ajax({
            url: "ajax/vocabulaire.php?tableau_entier=true",
            method: "GET"
        })
            .done(function (response) {
                $("#test-area").html(response);
